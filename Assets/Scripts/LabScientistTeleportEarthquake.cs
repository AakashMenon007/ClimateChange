...
public class LabScientistTeleportEarthquake : MonoBehaviour
{
    ...
    [YarnCommand("teleportEarthquake")]
    ...
    private IEnumerator TeleportSequence()
    {
        ...
        if (npc3D != null)
        {
            npc3D.talkToNode = "Earthquake";
            npc3D.ResetNodeUsage(); // Allow re-triggering the node
            Debug.Log("Updated talkToNode to: Earthquake");
        }
